...
Config.VehiclesData = {
    ['car'] = {
        ...
        { name = 'f812', label = '812 Superfast', model = '', price = 30000000, stock = 1, img = '', category = 'super', discount = 0, information = {TopSpeed = 215, Braking = 88, Acceleration = 80, Suspension = 84, Handling = 82} },
        { name = 'polbuffwb', label = 'Police Buffalo STX', model = '', price = 0, stock = 1, img = '', category = 'sports', discount = 0, information = {TopSpeed = 215, Braking = 88, Acceleration = 80, Suspension = 84, Handling = 82} },
